...
// ─── Throttle Supabase writes (max once per 2 minutes) ────────────
let lastSaveTime = 0;
  ...
  sock.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      if (errorMessage.includes('conflict') || errorMessage.includes('Conflict')) {
        console.log('⚠️ CONFLICT DETECTED: Bot is running in two places!');
        console.log('🛑 Stopping this instance to resolve conflict...');
        process.exit(1);
      }
